...
def ai_resume_review(request, application_id):
    ...
    job_description = get_job_description(resume.job_id)  
    questions = analyze_resume(resume.text, job_description)

    # Nomzodga email yuborish
    send_test_notification_email(resume.user.email, job_description)
