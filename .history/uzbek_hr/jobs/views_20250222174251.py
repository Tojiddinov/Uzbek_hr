...
def test_dashboard(request):
    ...
    print(f"User: {user}, Questions: {questions}")  # <-- Shu joyda log qo‘shib tekshiring
...
def send_test_invite_email(user_email, job_title):
    ...
    UZBEK HR jamoasi
    """
    send_mail(subject, message, settings.EMAIL_HOST_USER, [user_email], fail_silently=False)  # <-- user_email ishlatish kerak!
