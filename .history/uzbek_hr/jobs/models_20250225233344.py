...
class JobApplication(models.Model):
    ...
    ai_generated_questions = models.JSONField(default=list)  # AI tomonidan berilgan savollar
    test_answers = models.JSONField(default=dict)  # Job seeker javoblari
    test_deadline = models.DateTimeField(null=True, blank=True)  # Test tugash muddati
    ...
    def save(self, *args, **kwargs):
        """Status o‘zgarganda yoki AI-generated questions qo‘shilganda email yuborish"""
        if self.pk:
            try:
                old_application = JobApplication.objects.get(pk=self.pk)
                
                # Agar status yoki AI-generated questions o‘zgarsa
    ...
    def send_status_email(self):
        """Ariza statusi o‘zgarsa, job seekerga email yuborish"""
    ...
    def send_interview_questions_email(self):
        """AI-generated interview questionsni job seekerga yuborish"""
...
class TestDashboard(models.Model):
    ...
    is_active = models.BooleanField(default=True)  # Only visible if candidate passed screening
    created_at = models.DateTimeField(auto_now_add=True)
    completed_at = models.DateTimeField(null=True, blank=True)

    def __str__(self):
        return f"Test for {self.application.job_seeker.username}"