...
def test_dashboard(request):
    ...
    # Test Dashboard ni olish
    test_dashboard = get_object_or_404(TestDashboard, application=application)
    # test_dashboard = TestDashboard.objects.get(application__job_seeker=request.user)
