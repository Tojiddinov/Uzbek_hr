...
from .forms import JobApplicationForm, ResumeForm, JobForm
from .models import Job, CustomUser, JobApplication, JobPost
...
def ai_resume_review(request, application_id):
    """
    Handles AI resume review and generates interview questions.
    """
    application = get_object_or_404(JobApplication, id=application_id)
