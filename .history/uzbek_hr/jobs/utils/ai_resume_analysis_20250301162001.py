...
def analyze_resume(resume_text, job_title, job_description):
    if not resume_text.strip() or not job_description.strip() or not job_title.strip():
        return ["Error: Resume, Job Title, or Job Description is empty."]

    try:
        # ✅ To‘g‘ri argumentlar bilan chaqirilgan
        ...
        # ✅ ChatCompletion javobni ajratish
