...
class JobApplication(models.Model):
    ...
    resume = models.FileField(upload_to='resumes/', max_length=255, blank=False, null=False)  # Required
    cover_letter = models.FileField(upload_to='cover_letters/', max_length=255, blank=False, null=False)  # Required
