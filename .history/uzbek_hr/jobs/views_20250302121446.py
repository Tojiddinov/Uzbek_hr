...
def shortlist_dashboard(request):
    ...
    shortlisted_applicants = JobApplication.objects.filter(shortlisted=True)
    return render(request, "test/shortlist_dashboard.html", {"applications": shortlisted_applicants})
