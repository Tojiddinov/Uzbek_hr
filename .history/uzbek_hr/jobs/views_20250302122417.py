...
def shortlist_dashboard(request):
    ...
    # Har bir ish bo‘yicha shortlist qilingan nomzodlarni guruhlash
    jobs_with_shortlisted_applicants = {}

    shortlisted_applications = JobApplication.objects.filter(shortlisted=True).select_related("applicant", "job")
    ...
    return render(request, "test/sshortlist_dashboard.html", {"jobs": jobs_with_shortlisted_applicants})
