...
class JobApplication(models.Model):
    ...
    def send_status_email(self):
        ...
        send_mail(subject, message, "jurabeksodiqovich@gmail.com", [self.email], fail_silently=True)
...
class TestDashboard(models.Model):
    application = models.OneToOneField(JobApplicationApplication, on_delete=models.CASCADE)
