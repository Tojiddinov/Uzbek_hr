...
class JobApplication(models.Model):
    ...
    shortlisted = models.BooleanField(default=False)  # Shortlist statusi
    ai_generated_questions = models.JSONField(null=True, blank=True)  # AI-generated savollar
    test_deadline = models.DateTimeField(null=True, blank=True)  # Test uchun deadline
    test_answers = models.JSONField(default=dict, blank=True)  # Kandidatning javoblari
