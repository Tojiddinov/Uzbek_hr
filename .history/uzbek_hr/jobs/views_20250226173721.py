...
def job_seeker_dashboard(request):
    ...
    test_available = AIInterviewQuestion.objects.filter(user=request.user).exists()
...
def generate_interview_questions(job_title, resume_text):
    ...
    try:
        response = openai.ChatCompletion.create(
            model="gpt-4o-mini",  # ✅ To‘g‘ri model nomi
    ...
    except OpenAIError as e:  # ✅ To‘g‘ri error handling
        print("OpenAI API Error:", str(e))  # Debug uchun
